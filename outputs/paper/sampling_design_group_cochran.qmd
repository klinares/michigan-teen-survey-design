...
repo_path <- "D:/repos/UMD_classes_code/applied_sampling_SURV625/project/data/"
```
...
school_frame <- read_xls(str_c(repo_path, "MI_school_frame_head_counts.xls"))
...
```{r}
# linkings schools
sample_selected <- read_xlsx(str_c(repo_path, "sample_selected.xlsx"))
...
f_overall <- 0.0057
oneschool <- read_csv(str_c(repo_path, "schoolframe.csv"))
MOS_7 <- 242
